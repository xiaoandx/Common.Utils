...
namespace Common.Utils
{
    ...
    public class PictureCAPTCHA
    {
        ...
        #region constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Common.Utils.PictureCAPTCHA"/> class. default length is 4 with number list 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Common.Utils.PictureCAPTCHA"/> class with number list;
        /// </summary>
        /// <param name="Length">Length.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Common.Utils.PictureCAPTCHA"/> class.
        /// </summary>
        /// <param name="Length">Length.</param>
